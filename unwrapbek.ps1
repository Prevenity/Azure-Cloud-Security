# source https://github.com/azureautomation/azure-disk-encryption-retrieve-bitlocker-bek-from-keyvault/blob/master/RetrieveBekFromKeyVault.ps1
...
Param(
  [Parameter(Mandatory = $true, 
             HelpMessage="Versioned URL of the KeyVault secret that contains wrapped disk encryption key")]
  [ValidateNotNullOrEmpty()]
  [string]$BEKtUrl,

  [Parameter(Mandatory = $true,
             HelpMessage="Mandatory: Versioned URL of the key encryption key that is used to wrap the disk encryption key")]
  [ValidateNotNullOrEmpty()]
  [string]$kekUrl,
...
$getSecretRequestUrl = $BEKUrl+ "?api-version=2015-06-01";
